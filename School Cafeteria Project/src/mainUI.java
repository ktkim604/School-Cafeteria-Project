...
public class mainUI extends JFrame implements ActionListener {         //학식주문의 mainUI클래스
   ...
   public mainUI(){
      ...
      //bt_menu[]에 메뉴 이미지 삽입
      bt_menu[0] = new JButton(new ImageIcon("img/menu/제육덮밥.png"));
      bt_menu[1] = new JButton(new ImageIcon("img/menu/비빔밥.png"));
      bt_menu[2] = new JButton(new ImageIcon("img/menu/비빔국수.png"));
      bt_menu[3] = new JButton(new ImageIcon("img/menu/닭볶음탕.png"));
      bt_menu[4] = new JButton(new ImageIcon("img/menu/치킨덮밥.png"));
      bt_menu[5] = new JButton(new ImageIcon("img/menu/치즈불닭.png"));
      bt_menu[6] = new JButton(new ImageIcon("img/menu/감자튀김.png"));
      bt_menu[7] = new JButton(new ImageIcon("img/menu/소떡소떡.png"));
      bt_menu[8] = new JButton(new ImageIcon("img/menu/물만두.png"));
      bt_menu[9] = new JButton(new ImageIcon("img/menu/콜라.png"));
      bt_menu[10] = new JButton(new ImageIcon("img/menu/사이다.png"));
      ...
      JButton order[] = new JButton[3];
        ...
        //주요기능 3가지 버튼
        order[0] = new JButton(new ImageIcon("img/menu/close.png"));     //close이미지 삽입
        order[1] = new JButton(new ImageIcon("img/menu/reset.png"));    //reset이미지 삽입
        order[2] = new JButton(new ImageIcon("img/menu/order.png"));     //order이미지 삽입
           ...
           public void actionPerformed(ActionEvent e) {
              ...
              if(answer == JOptionPane.YES_OPTION) {   
                 ...
                 //total: 총 금액이 0이 아닐경우, 주문담기 table의 해당 단가, 수량을 가져와서 메세지 출력
                    ...
                    for(int i=0; i<table.getRowCount(); i++) {                     //주문담기 table의 해당 단가, 수량을 가져와서 메세지 출력
